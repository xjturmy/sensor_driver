...
bool DataProcess::processObjectListMessage(char *in,RadarObjectList *o_list)
{
    ...
    // std::cout << "list.ObjectList_NumOfObjects----1----:" <<o_list->ObjectList_NumOfObjects<< std::endl;
...
bool DataProcess::processBasicStatusMessage(char *in,RadarBasicStatus *basic_status)
{
    ...
    basic_status->Status_Voltage = (unsigned char)(in[81]);
    basic_status->Status_Temperature = (unsigned char)(in[82]);
    basic_status->Status_Blockage = (unsigned char)(in[83]);
