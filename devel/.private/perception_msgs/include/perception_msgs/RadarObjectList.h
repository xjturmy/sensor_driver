...
struct RadarObjectList_
{
  ...
  _ObjectList_NumOfObjects_type ObjectList_NumOfObjects;
   ...
   typedef std::vector< ::perception_msgs::radarobjects_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::perception_msgs::radarobjects_<ContainerAllocator> >> _object_array_type;
...
struct MD5Sum< ::perception_msgs::RadarObjectList_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xaf0d730d68d20a63ULL;
  static const uint64_t static_value2 = 0xea651752439590e3ULL;
};
...
struct Printer< ::perception_msgs::RadarObjectList_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::perception_msgs::RadarObjectList_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.object_array.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::perception_msgs::radarobjects_<ContainerAllocator> >::stream(s, indent + "    ", v.object_array[i]);
    }
  }
};
