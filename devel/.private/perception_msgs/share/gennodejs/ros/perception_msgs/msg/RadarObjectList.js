...
let radarobjects = require('./radarobjects.js');
...
class RadarObjectList {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.object_array.forEach((val) => {
      bufferOffset = radarobjects.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.object_array[i] = radarobjects.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 187 * object.object_array.length;
    return length + 55;
  }
  ...
  static md5sum() {
    ...
    return 'af0d730d68d20a63ea651752439590e3';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.object_array !== undefined) {
      ...
      for (let i = 0; i < resolved.object_array.length; ++i) {
        resolved.object_array[i] = radarobjects.Resolve(msg.object_array[i]);
      }
    }
    else {
