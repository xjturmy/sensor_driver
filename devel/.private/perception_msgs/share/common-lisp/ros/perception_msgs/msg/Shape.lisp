...
(cl:defmethod cl:initialize-instance :after ((m <Shape>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Shape)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name perception_msgs-msg:<Shape> is deprecated: use perception_msgs-msg:Shape instead.")))
...
(cl:defmethod footprint-val ((m <Shape>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_msgs-msg:footprint-val is deprecated.  Use perception_msgs-msg:footprint instead.")
  (footprint m))
