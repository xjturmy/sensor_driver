...
(cl:defmethod cl:initialize-instance :after ((m <Semantic>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Semantic)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name perception_msgs-msg:<Semantic> is deprecated: use perception_msgs-msg:Semantic instead.")))
