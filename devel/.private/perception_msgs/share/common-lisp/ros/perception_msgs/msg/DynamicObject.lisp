...
(cl:defclass <DynamicObject> (roslisp-msg-protocol:ros-message)
  ((id
   ...
   (semantic
    :reader semantic
    :initarg :semantic
    :type perception_msgs-msg:Semantic
    :initform (cl:make-instance 'perception_msgs-msg:Semantic))
   (state
    :reader state
    :initarg :state
    :type perception_msgs-msg:State
    :initform (cl:make-instance 'perception_msgs-msg:State))
   (shape
    :reader shape
    :initarg :shape
    :type perception_msgs-msg:Shape
    :initform (cl:make-instance 'perception_msgs-msg:Shape)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DynamicObject>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DynamicObject)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name perception_msgs-msg:<DynamicObject> is deprecated: use perception_msgs-msg:DynamicObject instead.")))
...
(cl:defmethod semantic-val ((m <DynamicObject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_msgs-msg:semantic-val is deprecated.  Use perception_msgs-msg:semantic instead.")
  (semantic m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DynamicObject>)))
  ...
  "5d4fcb8647579f19d1105f4becf14940")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DynamicObject)))
  "Returns md5sum for a message object of type 'DynamicObject"
  "5d4fcb8647579f19d1105f4becf14940")
